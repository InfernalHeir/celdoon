...
if(isset($_POST['submit']))
{
   ...
   // $pro_image4 = $_FILES['pro_image4'];
    ...
    $pro_dis_price= $pro_mrp-($pro_dis*$_1st_pro_price/100);
        
    
   
   // $stmt=$conn->prepare("INSERT INTO `product`( `1st_pro_name`, `1st_pro_price`, `pro_dis`, `pro_dis_price`,`shipping_charge`, `pro_unit`, `pro_detail`, `pro_other_name`, `pro_life`, `pro_manufacture`, `pro_disclaimer`, `pro_status`, `pro_image1`, `pro_image2`, `pro_image3`, `pro_image4`, `tax`, `type`, `tot_unit`) VALUES ($_1st_pro_name','$_1st_pro_price','$pro_dis','$pro_dis_price','$shipping_charge','$pro_unit','$pro_detail','$pro_other_name','$pro_life','$pro_manufacture','$pro_disclaimer',1,'$target1','$target2','$target3','$target4','$tax','$type','$pro_type')");
   $stmt=$conn->prepare("INSERT INTO`bestdeal`(`1st_pro_name`,`2nd_pro_name`,`1st_pro_price`,`2nd_pro_price`,`1st_pro_img1`,`1st_pro_img2`,`1st_pro_img3`,`2nd_pro_img1`,`2nd_pro_img2`,`2nd_pro_img3`,`pro_status`, `pro_dis`,`pro_dis_price`,`shipping_charge`,`pro_unit`,`1st_pro_desc`,`2nd_pro_desc`,`tax`,`pro_life`,`total_unit`,`1st_pro_brand`,`2nd_pro_brand`,`1st_pro_model`,`2nd_pro_model`,`pro_disclaimer`)VALUES
  ('$_1st_pro_name','$_2nd_pro_name','$_1st_pro_price','$_2nd_pro_price','$target1','$target2','$target3','$target4','$target5','$target6',1,'$pro_dis','$pro_dis_price','$shipping_charge',5,'$_1st_pro_desc','$_2nd_pro_desc','$tax','$pro_life','$total_unit','$_1st_pro_brand','$_2nd_pro_brand','$_1st_pro_model','$_2nd_pro_model','$pro_disclaimer')");
   if($stmt->execute())
	{
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" name="form1" onSubmit="return check();">
                     ...
                     <div class="row">
                       <div class="col-xs-6 col-sm-6 col-md-3">
                           <label>  Name :</label>
                                  <input type="text" name="1st_pro_name"  class="form-control input-lg">
                        </div>
                                 <div class="col-xs-2 col-sm-2 col-md-3">
                                    <label>Price :</label>
                                        <input type="text" id="myNumber" name="1st_pro_price" class="form-control input-lg">
                                         </div>
                                         <div class="col-xs-2 col-sm-2 col-md-3">
                                        ...
                                        <input type="text" name="total_unit"  class="form-control input-lg">
                                        </div>
                                    </div>
                                    <div class="row">
                                     <div class="col-xs-10 col-sm-10 col-md-10">
                                        <label>Detail / Featurs :</label>
                                            <input type="text" name="1st_pro_desc"  class="form-control input-lg">
                                         </div>
                            ...
                            <!--<div class="col-xs-6 col-sm-6 col-md-3">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  ...
                                  <input type="text" name="1st_pro_brand"  class="form-control input-lg">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                <label>Product Model :</label>
                                <input type="text" name="1st_pro_model"  class="form-control input-lg">
                                </div>
                                </div>
                                ...
                                <div class="row">
                                 <div class="col-xs-6 col-sm-6 col-md-4">
                                    <label>Image 1 :</label>
                                      <input type="file" name="1st_pro_img1" >
                                 </div>
                                 <div class="col-xs-6 col-sm-6 col-md-4">
                                   <label>Image 2 :</label>
                     ...
                     <div class="row">
                       <div class="col-xs-6 col-sm-6 col-md-3">
                           <label>  Name :</label>
                                  <input type="text" name="2nd_pro_name"  class="form-control input-lg">
                        </div>
                                 <div class="col-xs-2 col-sm-2 col-md-3">
                                    <label>Price :</label>
                                        <input type="text" id="myNumber" name="2nd_pro_price" class="form-control input-lg">
                                         </div>
                                        <!-- <div class="col-xs-2 col-sm-2 col-md-3">
                                         <label>Discount % :</label>
                                         <input type="text" name="pro_dis" class="form-control input-lg">
                                    ...
                                    <div class="row">
                                     <div class="col-xs-10 col-sm-10 col-md-10">
                                        <label>Detail / Featurs :</label>
                                            <input type="text" name="2nd_pro_desc"  class="form-control input-lg">
                                         </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <label>Product Brand :</label>
                                  <input type="text" name="2nd_pro_brand"  class="form-control input-lg">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                <label>Product Model :</label>
                                <input type="text" name="2nd_pro_model"  class="form-control input-lg">
                                </div>
                                </div>
