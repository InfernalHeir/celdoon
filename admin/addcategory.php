...
if(isset($_POST['submit']))
{
    ...
    if($catname=='' && $pro_image1=='')
    {
        echo "<script>alert('Enter Category Name And Select Image.');</script>";
    }
    else 
    {
	...
	move_uploaded_file($_FILES['pro_image1']['tmp_name'], $target1);   //Tells you if its all ok	
       ...
       // $sql1="INSERT INTO category (cat_name,cat_status,cat_image) VALUES ('$catname','1','$Filename1')";
        $stmt=$conn->prepare("INSERT INTO category (cat_name,cat_status,cat_image) VALUES ('$catname','1','$Filename1')");
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        ...
                                                        <input type="text" name="catname"  class="form-control input-lg">
                                                    </div>
                                                </div>
