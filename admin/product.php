<?php
    ...
    if((isset($_GET['act'])) and ($_GET['act']=='del'))
    {
       ...
       // $sql1="UPDATE  product SET pro_status ='0' WHERE pro_id='$id'";
        $stmt=$conn->prepare("UPDATE  product SET pro_status ='0' WHERE pro_id='$id'");
    ...
    if((isset($_GET['act1'])) and ($_GET['act1']=='del1'))
    {
        ...
        //$sql1="UPDATE  product SET pro_status ='1' WHERE pro_id='$id'";
         $stmt=$conn->prepare("UPDATE  product SET pro_status ='1' WHERE pro_id='$id'");
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="col-xs-2">
                 <a type="submit" href="addproduct.php" style="margin-top: 10px;" class="btn btn-primary">Add Product</a></h4>
                </div>
				<div class="col-xs-12">
            ...
            $stmt=$conn->prepare("SELECT * FROM product ORDER BY pro_id DESC");
           $stmt->execute();
         ...
         <td><img src="<?php echo $row['pro_image1'];?>" height="100px" width="100px"></td>
        <td>
   ...
   ?>
     ...
     <td>
        ...
        {
         ?>
      <a href="product.php?act=del&id=<?php echo $news_id;?>" class="btn btn-primary">Enable</a>
     <?php 
       }
       else
      {
     ?>
    <a href="product.php?act1=del1&id=<?php echo $news_id;?>" class="btn btn-primary">Disable</a>
                  <?php 
                   }
                  ?>
                </td>
